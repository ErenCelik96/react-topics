...
function App () {
  ...
  }), [search, studentsList]) //useMemo ile her aramada gereksiz yere render edilmesini engelledik, (import ettik) useMemo(()=>fonksiyon, [])
  //filtreleme fonksiyonu

  const add = useCallback(()=> {
    setStudentList([...studentsList, {id: studentsList.length + 1, name:"Edward CW"}]) 
    //...studentsList = listenin geri kalanını da al sıradaki yazdığımı ekle
  }, [studentsList]) //
